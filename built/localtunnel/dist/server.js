...
const subdomainToPath = new Map();
function generateSubdomain(length = 10) {
...
export function createTunnelServer(options) {
    ...
    httpServer.on("request", (req, res) => {
        ...
        if (options.globalAuth) {
            ...
            if (credentials.user !== expectedUser ||
